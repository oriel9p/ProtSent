...
CONTRASTS = [
    ...
    ("vanilla35m_clean@10000", "late-r2-protsentv2-35m@10000",
     "init: ESM2 - ProtSent-V2 (35M, both @10k)"),
    ("late-r2-protsentv2-35m@10000", "protsent_v2_zeroshot",
     "late-trained 128d - untrained raw 480d (V2-35M)"),
